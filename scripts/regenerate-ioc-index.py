#!/usr/bin/env python3
"""
regenerate-ioc-index.py — Rebuild threats/iocs/_master-index.yaml from every
...
Usage:
    python scripts/regenerate-ioc-index.py [--dry-run]
...
def write_index(lookup: dict, stats: dict, cross_actor: dict, dry_run: bool) -> None:
    output = {
        ...
        "generated_by": "scripts/regenerate-ioc-index.py",
        "stats": stats,
        "lookup": lookup,
    ...
    INDEX_PATH.write_text(
        ...
        "# GENERATED FILE — regenerated by scripts/regenerate-ioc-index.py\n"
        "# DO NOT HAND-EDIT.\n\n"
        + dumped
    )
