---
raw_id: raw-2026-07-19-flash-0000-000
collected_at: 2026-07-19T00:04:00-04:00
run_id: flash-sweep-20260719-000000
...
# FLASH sweep coverage record — 2026-07-19 00:00 EDT
...
nothing queued or posted. First clean sweep of 2026-07-19.

Window: ~2026-07-18T18:00 → 2026-07-19T00:00 EDT (6h primary). Prior sweep of
record: 2026-07-18 18:00 FLASH (raw-2026-07-18-flash-1800-000). Saturday-night /
...
- cisa-kev (JSON, direct WebFetch) — NO entries dated 2026-07-18 or 2026-07-19.
  Most recent adds remain 2026-07-16: CVE-2026-58644 SharePoint (VT-041, due
  07-19), CVE-2026-25089 + CVE-2026-39808 FortiSandbox (due 07-19) — all already
  tracked. No new KEV additions this window. A passing KEV deadline is not a
  FLASH trigger.
...
- Oracle EBS CVE-2026-46817 (VT-043, KEV due 07-18, now past-due): no new
  attribution, no named A&D/DIB victim, no Mandiant/GTIG direct exploitation
  confirmation, no ransomware-campaign-use flip. KEV deadline passing without a
  new signal is not a trigger. Quiet.
- SharePoint CVE-2026-58644 (VT-041, KEV due today 07-19): no escalation net-new
  this window. Quiet.
- FortiSandbox CVE-2026-25089 / CVE-2026-39808 (VT-043, KEV due today 07-19): no
  escalation. Quiet.
- WordPress Core CVE-2026-63030 (wp2shell): no new escalation this window (no
  named A&D victim, no mass-exploitation telemetry beyond the ITW-onset already
